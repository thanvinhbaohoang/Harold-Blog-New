...
export default function MarkdownEditor(){
    ...
    const SuccessAlert = () => {
        return (
            ...
            border-green-400 text-green-700 px-4 py-3 rounded" role="alert">
                ...
                <span className="block sm:inline"> Your Blog Is Successfully Submitted.</span>
    ...
    return(
       ...
       <div className="w-[50vw] p-4  flex flex-col gap-4 mb-10">
            ...
            <button className="bg-purple-500 hover:bg-purple-700 bg-opacity-30 transition text-white font-bold py-2 px-4 rounded">
                Edit
            </button>
            ...
            <div className="flex h-full border-2 border-slate-600 rounded-xl p-4">
                    <form className="flex flex-col h-full w-full gap-2">
                            ...
                            <input type="text" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-3xl font-bold rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500" placeholder="New Blog Title Here ..." required/>
                            <input type="text" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500" placeholder="Add up to 3 tags ..." required/>
                            ...
                            {/* <div className="rounded-lg h-[60vh] border focus:ring-purple-500 focus:border-purple-500  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500 border-gray-300"> */}
                                <textarea id="text" className="rounded-lg h-[60vh] border focus:ring-purple-500 focus:border-purple-500  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-purple-500 dark:focus:border-purple-500 border-gray-300 p-2.5 w-full  text-md dark:bg-gray-700 dark:text-gray-200 text-gray-700  "placeholder="Write Your Blog Content Here ..."></textarea>
                            {/* </div> */}
