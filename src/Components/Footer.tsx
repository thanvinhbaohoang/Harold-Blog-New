...
export default function Footer() {
    return (
        <div className="text-white bottom-0">
          ...
          <div class="flex flex-col md:flex-row justify-between items-center border-b dark:border-gray-600 py-1">
            
            <ul class="flex flex-wrap justify-around md:justify-start md:gap-1">
              <button type="button" class="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl transitionfocus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                        Subscribe
                    </button>
          ...
          <div class="text-gray-400 text-xs font-light py-4">© 2023 | Harold Than<p class="md:float-right">Licensed Under Who Cares, Steal It If You Want </p></div>
