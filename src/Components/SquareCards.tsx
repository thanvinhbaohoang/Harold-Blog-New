...
function SquareCard({post}:{post:Blog}){
    ...
    return(
       <Link to = "/blog">
            ...
            <div class=" bg-white border hover:-translate-y-1 hover:outline-dotted outline-2 outline-indigo-300 transition border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
